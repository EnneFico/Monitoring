...
#Indices
#1. R_code_first (26)
#2. R_code_multipanel.r (58)
#3. R_code_spatial.r (113)
#4. R_code_multivariate.r (205)
#5. R_code_remotesensing_class.r (251)
#6. densitymap_point_pattern_analysis.r (427)
#7. R_code_ecosystem_functions.r (501)
#8. R_code_PCA_remote_sensing.r (611)
#9a. R_code_defor_ndvi.r (697)
#9b. R_code_faPAR.r (742)
#10. R_code_radiance.r (830)
#11. R_code_faPAR10.r (884)
#12. R_code_EBVs.r (954)
#13. R_code_snow.r (1087)
#14. R_code_no2.r (1244)
#15. R_code_temp_interpolation.r (1348)
#16. R_code_temp_sdm.r (1431)
...
5. R_code_remotesensing_class.r
...
6. densitymap_point_pattern_analysis.r
...
##########################Day 2#######################
setwd("C:/Users/nicof/lab/snow")  #PC
...
#lapply with snow database, let's take back the snow data
setwd("C:/snow/")
...
15. R_code_temp_interpolation.r
...
#####################PERSEPHONE IS BACK!###################
#################Majella National Park 2020 Spring#########################
